...
import br.com.alex.restaurante.entity.Ordem;
import br.com.alex.restaurante.vo.ItensPrincipaisVo;
...
public class OrdemDao {
    ...
    public List<ItensPrincipaisVo> consultarItensMaisVendidos(){
        String jpql = "SELECT new br.com.alex.restaurante.vo.ItensPrincipaisVo(" +
