package br.com.alex.restaurante.dao;

import br.com.alex.restaurante.entity.Categoria;
import br.com.alex.restaurante.entity.Endereco;
import br.com.alex.restaurante.vo.ClienteVo;
...
public class EnderecoDao {
    ...
    public List<ClienteVo> consultarClientes(final String estado, final String cidade, final String rua) {
        String jpql = "SELECT new br.com.alex.restaurante.vo.ClienteVo(e.cliente.clienteId.cpf,e.cliente.nome) " +
