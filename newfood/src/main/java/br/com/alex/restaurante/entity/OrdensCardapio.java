package br.com.alex.restaurante.entity;
...
public class OrdensCardapio {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private br.com.alex.restaurante.entity.Cardapio cardapio;
    ...
    public OrdensCardapio(br.com.alex.restaurante.entity.Cardapio cardapio, Integer quantidade) {
    ...
    public br.com.alex.restaurante.entity.Cardapio getCardapio() {
        return cardapio;
    }

    public void setCardapio(br.com.alex.restaurante.entity.Cardapio cardapio) {
        this.cardapio = cardapio;
    }
